...
async function run() {
   ...
   // await page.type('#post_text', 'Feeling sweaty after an invigorating workout 💦', {delay: 80}); //types in the textbox
    ...
    'Installed with AMD Ryzen 9 9800X3D, this fembot model features advanced AI capabilities and personality customization.'];
...
} //run function.  This program officially completed at 0211hrs on 1/16/2024
